...
const SearchSelect = ({
  ...
  const dataSelectConfig = {
    ...
    dropdownClasses: 'advance-select-menu max-h-52 pt-0 overflow-y-auto w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl rounded-xl z-50 p-1.5',
