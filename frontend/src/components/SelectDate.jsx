      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute z-50 mt-2 p-4 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border border-slate-200 dark:border-slate-800 shadow-2xl rounded-2xl right-0 sm:left-0 max-w-sm"
            style={{ width: '310px' }}
          >
            <calendar-date
              ref={calendarRef}
