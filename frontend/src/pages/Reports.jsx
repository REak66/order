    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 flex flex-wrap gap-4 items-end">
        <div className="space-y-1">
          ...
          <select
            className="px-4 py-2 bg-slate-50 dark:bg-slate-800 rounded-xl outline-none border-none focus:ring-2 focus:ring-primary-500 transition min-w-[150px]"
                      ...
                      {Array.from({ length: daysInMonth }, (_, dayIndex) => {
                        ...
                        return (
                          <td key={day} className="px-1 py-2">
                            <div className={cn(
                              "mx-auto h-7 w-9 border border-slate-200 dark:border-slate-700",
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex justify-end gap-2">
                          <button
                            ...
                            className={cn(
                              "inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-semibold transition",
