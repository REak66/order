          ...
          >
            {({ isActive }) => (
              <>
                {isActive && (
                  <span
                    className="absolute inset-0 bg-primary-50 dark:bg-primary-900/10 border-l-4 border-primary-500 z-0 motion-preset-fade motion-duration-200"
                  />
                )}
  ...
  return (
    <div className="flex h-screen w-full bg-slate-50 dark:bg-slate-950 overflow-hidden">
      ...
      {isSidebarOpen && (
        <>
          <div
            className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-40 lg:hidden motion-preset-fade motion-duration-200"
            onClick={() => setIsSidebarOpen(false)}
          />
          <aside
